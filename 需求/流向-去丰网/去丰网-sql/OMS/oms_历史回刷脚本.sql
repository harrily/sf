...
insert overwrite table dm_ordi_predict.dws_cityflow_dynamic_order_hi_backup20230612 partition (inc_day,inc_dayhour)
 select 
  order_dt
  ,city_flow
  ,all_order_num
...
(select 
 ...
 /*
 CREATE TABLE `dm_ordi_predict.dws_cityflow_dynamic_order_hi_backup20230612`(
